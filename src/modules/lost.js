...
const GET_SPECIFIC_LOST_ITEM = "GET_SPECIFIC_LOST_ITEM";
const GET_SPECIFIC_LOST_ITEM_SUCCESS = "GET_SPECIFIC_LOST_ITEM_SUCCESS";
const GET_SPECIFIC_LOST_ITEM_ERROR = "GET_SPECIFIC_LOST_ITEM_ERROR";

const ADJUST_LOST_COMMENT = "ADJUST_LOST_COMMENT";
const ADJUST_LOST_COMMENT_SUCCESS = "ADJUST_LOST_COMMENT_SUCCESS";
const ADJUST_LOST_COMMENT_ERROR = "ADJUST_LOST_COMMENT_ERROR";

const DELETE_LOST_COMMENT = "DELETE_LOST_COMMENT";
const DELETE_LOST_COMMENT_SUCCESS = "DELETE_LOST_COMMENT_SUCCESS";
const DELETE_LOST_COMMENT_ERROR = "DELETE_LOST_COMMENT_ERROR";

const REGISTER_LOST_COMMENT = "REGISTER_LOST_COMMENT";
const REGISTER_LOST_COMMENT_SUCCESS = "REGISTER_LOST_COMMENT_SUCCESS";
const REGISTER_LOST_COMMENT_ERROR = "REGISTER_LOST_COMMENT_ERROR";

const DELETE_LOST_ITEM = "DELETE_LOST_ITEM";
